...
To verify that Pixie is running in your environment you can check the admin page of your cloud ([Cosmic](https://work.getcosmic.ai/admin) or [Community](https://work.withpixie.ai/admin)) or run:
